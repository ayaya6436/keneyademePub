 ...
 */
require_once REDEL_FRAMEWORK . '/plugins/notify/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'redel_register_required_plugins' );
 ...
 */
function redel_register_required_plugins() {
	/*
    ...
    // Contact Form 7
    array(
	    'name'					=> esc_html__('Contact Form 7', 'redel'),
	    'slug'					=> 'contact-form-7',
	    'required'			=> true,
    ...
    // Redel Core
    array(
	    'name'					=> esc_html__('Redel Core', 'redel'),
	    'slug'     			=> 'redel-core',
	    'source'				=> 'http://victorthemes.com/plugins/redel-core.zip',
	    'required'			=> true,
	    'external_url'	=> 'https://victorthemes.com/',
    ),
    // MailChimp for WordPress
    array(
	    'name'					=> esc_html__('MailChimp for WordPress', 'redel'),
    ...
    // WP-PageNavi
    array(
	    'name'					=> esc_html__('WP-PageNavi', 'redel'),
	    'slug'					=> 'wp-pagenavi',
	    'required'			=> true,
    ...
    array(
	    'name'					=> esc_html__('WPBakery Visual Composer', 'redel'),
	    'slug'     			=> 'js_composer',
